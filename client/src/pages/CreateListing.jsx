...
export default function CreateListing() {
  return (
    <main className='p-3 max-w-4xl mx-auto'>
        <h1 className='text-3l font-semibold text-center my-7'>
            Create a Listing</h1>
            <form className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className='flex flex-col gap-4 flex-1'>
                    ...
                    rounded-lg' id='description' maxLength='102' minLength='10' required/>
                    ...
                    <div className='flex flex-wrap gap-6'>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <input type="number" id='bsthrooms' min='1' max='10' required 
                        className='p-3 border border-gray-300 rounded-lg'/>
                        <p>Baths</p>
                ...
                <div className="flex flex-col flex-1 gap-4">
                  <p className='font-semibold'>Images:
                    ...
                    <div className="flex gap-4">
                      ...
                      rounded uppercase hover:shadow-lg disable:opacity-80'>Upload</button>
                    </div>
